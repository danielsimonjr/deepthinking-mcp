...
### `src/export/visual/session-graph.ts`

- `SessionGraphModel` (interface)
...
- `ProofAnalysisDeps` (interface)
- `MAX_PROOF_STEPS` (constant)
- `MAX_PROOF_ATOMS` (constant)
- `MAX_PROOF_GAPS` (constant)
- `MAX_PROOF_ASSUMPTIONS` (constant)
- `MAX_PROOF_INCONSISTENCIES` (constant)
- `MAX_PROOF_CYCLES` (constant)
- `MAX_PROOF_NOTES` (constant)
...
### `src/taxonomy/advisory.ts`

- `toTaxonomyCharacteristics` (function)
- `SuggestedReasoningType` (interface)
- `ProblemClassification` (interface)
- `TaxonomyAdviceAvailable` (interface)
- `TaxonomyAdviceUnavailable` (interface)
- `TaxonomyAdviceInput` (interface)
- `TaxonomyAdviceDeps` (interface)
- `TaxonomyAdvice` (type)
- `MAX_TAXONOMY_SUGGESTIONS` (constant)
...
### `src/validation/advisory.ts`

- `AdvisoryValidatorLike` (interface)
