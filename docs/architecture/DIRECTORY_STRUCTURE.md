...
The codebase is organized into **16 modules** with **158 TypeScript files** totaling approximately **45,000 lines of code**.
...
**Files**: 7 | **Purpose**: Runtime logic for complex reasoning modes
...
| Type-only circular deps | 31 (safe) |

---

*Generated by Phase 9 consolidation (v7.0.1)*
